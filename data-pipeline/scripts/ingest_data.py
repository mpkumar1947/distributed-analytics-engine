...
# ------------------------------------------------------------------------------
# PATH SETUP (Go up TWO levels to hit the project root)
# ------------------------------------------------------------------------------
...
# Point to the CSV inside the data-pipeline/data folder
CSV_PATH = os.path.join(PROJECT_ROOT, "data-pipeline", "data", "courses_with_fileids.csv")
